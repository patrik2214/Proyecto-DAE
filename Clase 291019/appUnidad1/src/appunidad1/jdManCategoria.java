...
public class jdManCategoria extends javax.swing.JDialog {
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        ...
        try {
            if (btnNuevo.getText().equals("Nuevo")){
                ...
                btnNuevo.setText("Nuevo");
                objCategoria.registrar(Integer.parseInt(txtCodigo.getText()), txtNombre.getText(),txtDescripcion.getText() , this.chkVigencia.isSelected());
                limpiarControles();
                listarCategorias();
            }
        } catch (Exception e) {
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        // TODO add your handling code here:
        try {
            objCategoria.modificar( Integer.parseInt(txtCodigo.getText()), txtNombre.getText(),txtDescripcion.getText(),this.chkVigencia.isSelected());
            limpiarControles();
            listarCategorias();
        } catch (Exception e) {
             JOptionPane.showMessageDialog(this,e.getMessage());
    ...
    private void listarCategorias(){
        ...
        try {
            ...
            while(rsCat.next()){
                ...
                modelo.addRow(new Object[]{rsCat.getInt("codCategoria"),rsCat.getString("nomCategoria"),rsCat.getString("descripcion"),vigencia});
           }
        } catch (Exception e) {
        }
    }
