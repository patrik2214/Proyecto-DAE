 ...
 */
public class jdReporteResumenVentas extends javax.swing.JDialog {

    /**
     * Creates new form jdReporteProducto
     */
    public jdReporteResumenVentas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            ...
            JRViewer vistaReporte = new Reportes().reporteInterno("rp_ResumenVentas.jasper",null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdReporteResumenVentas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdReporteResumenVentas dialog = new jdReporteResumenVentas(new javax.swing.JFrame(), true);
