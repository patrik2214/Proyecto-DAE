...
public class jdTransacciones extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnGuardarT.setText("Guardar - Transacción");
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnGuardarT, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
    ...
    private void btnGuardarTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarTActionPerformed
        ...
        try {
            objTransaccion.ejecutarSentenciasTransacciones();
             JOptionPane.showMessageDialog( this, "Sentencias ejecutadas correctamente en la TRANSACCION...");
        } catch (Exception e) {
            JOptionPane.showMessageDialog( this, e.getMessage());
        }
