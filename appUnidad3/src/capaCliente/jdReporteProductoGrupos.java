 ...
 */
public class jdReporteProductoGrupos extends javax.swing.JDialog {

    /**
     * Creates new form jdReporteProducto
     */
    public jdReporteProductoGrupos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdReporteProductoGrupos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdReporteProductoGrupos dialog = new jdReporteProductoGrupos(new javax.swing.JFrame(), true);
