...
public class jdTCliente extends javax.swing.JDialog {
    clsCliente objCliente = new clsCliente();    
    public jdTCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        try {
            if (btnNuevo.getText().equals("Nuevo")){
                ...
                btnNuevo.setText("Nuevo");
                objCliente.registrarC(txtDni.getText(),txtRuc.getText(),txtNombres.getText(),txtTelefono.getText(),txtCorreo.getText(),txtDireccion.getText(),chkVigencia.isSelected(),objCliente.obtenerCodigoTipoCliente(cmbTipo.getSelectedItem().toString()) );
                limpiarControles();
            }
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdTCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdTCliente dialog = new jdTCliente(new javax.swing.JFrame(), true);
